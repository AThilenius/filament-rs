use crate::{
    ...
    material::Material,
    misc_types::{SwapChain, TransformManager},
    raw_bindings::*,
    renderer::Renderer,
    scene::Scene,
    vertex_buffer::VertexBufferBuilder,
    view::View,
};
use std::rc::Rc;
...
impl Engine {
    ...
    pub fn get_transform_manager(&mut self) -> TransformManager {
        TransformManager::new(self.clone())
    }
}
